...
async def media_stream():
    ...
    try:
        ...
        MIN_SPEECH_RMS_THRESHOLD = 650.0
    CHUNK_SILENCE_DURATION_SECONDS = 0.55
    DONE_SPEAKING_SILENCE_DURATION_SECONDS = 1.2
    MINCHUNK_DURATION_SECONDS = 0.9
    MAXCHUNK_DURATION_SECONDS = 10.0
    LEAD_IN_DURATION_SECONDS = 0.35
